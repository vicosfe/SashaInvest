...
<body>
    <div class="filterSignIn">


        <div class="filterSignInBlock">
            <h3>Авторизация <div class="closeForm"></div></h3>
            <div class="hrSignIn"></div>
            <form action="#" class="formSignIn directCommunicationForm">
                ...
                <div class="directCommunicationForm__group">      
                    ...
                    <span class="bar"></span>
                    <label class="directCommunicationLabel">Логин или Email</label>
                </div>

                <div class="directCommunicationForm__group">   
                    <input type="password" name="directCommunicationfio"  required>
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Пароль</label>
                </div>
                ...
                <div class="cattt">
                    <div class="cattt__left">
                        Забыли пароль?
                    </div>
                    <div class="cattt__right">
                        Регистрация
                    </div>
                </div>

                <div class="hrSignIn2"></div>
                <input type="reset" value="Сбросить" class="resetForm">
                <button type="submit" class="directCommunication__button butSignIn">Отправить</button>

            </form>
        </div>


        <div class="filterSignUpBlock">
            <h3>Авторизация <div class="closeForm"></div></h3>
            <div class="hrSignIn"></div>
            <form action="#" class="formSignUp directCommunicationForm">
                ...
                <div class="directCommunicationForm__group">   
                    <input type="password" name="directCommunicationfio" class="pass1" required>
                    <span class="highlight"></span>
                    <span class="bar"></span>
                    <label>Пароль</label>
                </div>
                ...
                <div class="directCommunicationForm__group">   
                    <input type="password" name="directCommunicationfio"  class="pass2" required>
                    <span class="highlight"></span>
                    <span class="bar"></span>
                ...
                <div class="hrSignIn2"></div>
                <input type="reset" value="Сбросить" class="resetForm">
                <button type="submit" class="directCommunication__button butSignUp">Отправить</button>
