...
$(".logistikaItem__map--hideJs").on("click", function(){
 ...
 $(resetForm).on("click",function () {
  if ($(directCommunicationEmail).val()){
    $($(directCommunicationEmail).siblings(".directCommunicationLabel")).addClass("directCommunicationLabelVALID");
  }else if ($(directCommunicationEmail).val()){
    $($(directCommunicationEmail).siblings(".directCommunicationLabel")).addClass("directCommunicationLabelVALID");
  }else $($(directCommunicationEmail).siblings(".directCommunicationLabel")).removeClass("directCommunicationLabelVALID");$($(directCommunicationEmail).siblings(".directCommunicationLabel")).removeClass("directCommunicationLabelVALID");

 })


var filterSignInBlock = $(".filterSignInBlock");
var filterSignIn = $(".filterSignIn");
$(filterSignIn).hide();
var signIn = $(".signIn");
...
var filterSignUpBlock = $(".filterSignUpBlock");

var cattt__right = $(".cattt__right");
$(cattt__right).on("click",function () {
  $(filterSignInBlock).hide();
  $(filterSignUpBlock).fadeIn();
});
var cattt__right2 = $(".cattt__right2");
$(cattt__right2).on("click",function () {
  $(filterSignUpBlock).hide();
  $(filterSignInBlock).fadeIn();
});
var formSignUp = $(".formSignUp");
var pass1 = $("pass1");
var pass2 = $("pass2");
var butSignUp = $(".butSignUp");
// $(butSignUp).on("click",function (e) {
//   event.preventDefault();
//   if ($(pass1).val() != $(pass2).val() || !$(pass1).val() || !$(pass2).val() ){
//     alert("Пароли не совпадают");
//   }
//     else $(formSignUp).submit()
// });
/**********************Language*******************/
